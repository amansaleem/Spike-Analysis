function [Posterior_all] = plot_some_decoding_newer4V1(animal, iseries,...
...
% temp1(temp1<5) = nan;
[spdDec,a, temp1, Ptemp] = spdDec.trainDecoder(temp1, es.spikeTrain,0);
...
switch type
    case 'contrast'
        base = es.traj>1 & es.contrast~=0 & ~isnan(es.traj) & es.gain==1 & es.roomLength==1 & es.smthBallSpd>5 & es.trajspeed>=0;
