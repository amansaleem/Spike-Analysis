    ...
    methods
        function obj = oneDimMap(varargin)
            ...
            pnames = {'dimensionality' 'variable' 'variable_range'...
                'smth_win' 'model'...
                'kfold' 'performance'...
                'train_mean' 'CVO' 'sampleRate' 'numBins' 'bins'};
            dflts  = {'1D' 'P' []...
                150 []...
                5 []...
                [] [] 60 50 []};
            [obj.dimensionality, obj.variable, obj.variable_range, ...
                ...
                obj.train_mean, obj.CVO, obj.sampleRate obj.numBins obj.bins] = ...
                internal.stats.parseArgs(pnames,dflts,varargin{:});
        end
        
        function [obj, prediction, X] = trainSpikeMap(obj, X, Y, smth_win, smthBins);
            if nargin<4
            ...
            if nargin<5
                ...
                [obj, prediction, X] = trainOneDimMap(obj, X, Y, smth_win, smthBins);
            end
        end
