function [units,NoUnitsFlag] = UnitLoad( spikedir, animal, iseries, iexp, ichan, icell, batchflag, fixtimingflag )
...
% 2010-05 ND added an optional output variable NoUnitsFlag that is 1 if
%   there are no units and 0 if there are units.
...
if exist('ichan','var') && length(ichan)==1
   ...
   NoUnitsFlag=0; % added by ND
   if nunits<1
       NoUnitsFlag=1; % added by ND
