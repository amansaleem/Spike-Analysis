function fig = UnitPlotTuning( unit, protocol, graphinfo, fig, AnalysisType )
...
% 2011-09 AA line 183: if the firing rate is zero displays a warning
...
if isfield(protocol,'pfilefreqs') && isempty(protocol.pfilefreqs)
   AnalysisType = 'Mean';
end
